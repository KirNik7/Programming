...
namespace ObjectOrientedPractics.Model
{
    ...
    {
        /// <summary>
        /// Проверяет, находится ли число в заданном диапазоне (для целочисленных значений).
        /// </summary>
        ...
        /// <summary>
        /// Проверяет, находится ли число в заданном диапазоне (для вещественных значений).
        /// </summary>
        /// <param name="value">Число.</param>
        /// <param name="min">Левая граница диапазона.</param>
        /// <param name="max">Правая граница диапазона.</param>
